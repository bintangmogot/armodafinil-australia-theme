            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-10 pb-10 border-b border-primary-dark/10" data-aos="fade-up">
                ...
                <div class="order-1 lg:col-span-2 lg:pr-8">
                    ...
                    <div class="flex items-center gap-4 mt-6">
                        <a href="https://www.facebook.com/profile.php?id=61591182224726" target="_blank" rel="noopener noreferrer" class="text-primary-dark/70 hover:text-primary-dark transition-colors" aria-label="Facebook">
                        ...
                        <a href="https://www.linkedin.com/company/armodafinil-australia/about/?viewAsMember=true" target="_blank" rel="noopener noreferrer" class="text-primary-dark/70 hover:text-primary-dark transition-colors" aria-label="LinkedIn">
