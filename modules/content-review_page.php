            ...
            <div class="lg:w-3/4 flex flex-col gap-6" id="reviews-wrapper">
                <div id="reviews-container" class="flex flex-col gap-6">
                    <?php if ( $reviews->have_posts() ) : ?>
                        ...
                        ?>
                            <div class="bg-primary rounded-2xl p-4 md:p-8 shadow-md text-white">
                ...
                <div id="reviews-pagination" class="mt-8 flex flex-col items-center">
                    ...
                    <?php if ( $reviews->max_num_pages > $paged ) : ?>
                        <a href="<?php echo esc_url( get_pagenum_link( $paged + 1 ) ); ?>" id="load-more-btn" class="inline-flex items-center gap-2 bg-[#d61e1e] text-white font-bold py-4 px-10 rounded-full hover:bg-red-700 transition-colors">
                            Load More
