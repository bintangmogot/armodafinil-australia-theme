            ...
            <form id="armo-review-form" method="POST" class="flex flex-col gap-6">
                ...
                <div>
                    ...
                    <div class="flex gap-2" id="star-rating-selector">
                        <?php for ($i = 1; $i <= 5; $i++) : ?>
                            <svg data-rating="<?php echo $i; ?>" class="star-icon w-8 h-8 text-accent cursor-pointer transition-colors fill-current" viewBox="0 0 20 20">
                ...
                <div class="mt-4 text-center">
                    <button type="submit" id="review-submit-btn" class="bg-[#FF0000] text-white font-bold py-4 px-10 rounded-full hover:bg-red-600 transition-colors w-full md:w-auto">
                        Submit your review
                    </button>
                </div>
            </form>
