        ...
        <div class="w-full pt-28 pb-6 md:pt-32 md:pb-16 lg:pt-36 lg:pb-20 text-white">
            ...
            <?php if ($button_text && $button_link) : ?>
                <div class="mt-5 lg:mt-6 w-full" data-aos="fade-up" data-aos-delay="400">
                    <a href="<?php echo esc_url($button_link); ?>" class="group flex md:inline-flex justify-center items-center gap-2 w-full md:w-auto bg-[#FF0000] hover:bg-[#dc0000] text-white font-bold text-base lg:text-lg px-4 lg:px-8 py-3 lg:py-3.5 rounded-full no-underline transition-all hover:shadow-lg hover:shadow-black/30 whitespace-nowrap">
