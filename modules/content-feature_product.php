                        ...
                        <div class="flex flex-col h-full">
                            <a href="<?php echo $permalink; ?>" class="group block w-full no-underline text-inherit flex-grow flex flex-col">
                                ...
                                <div class="text-center px-1 flex-grow flex flex-col">
                                    ...
                                    <div class="mt-auto">
                                        <span class="inline-flex items-center justify-center gap-1 md:gap-2 bg-[#ff0000] text-white py-2 px-3 md:px-6 rounded shadow-md font-bold text-sm md:text-base text-center hover:bg-red-700 transition-colors whitespace-nowrap">
                                            Buy Now 
