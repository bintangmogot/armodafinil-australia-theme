...
function armo_custom_reviews_anchor_button()
{
    ...
    echo '<a href="#product-reviews-section" class="inline-flex flex-col gap-1 lg:gap-1.5 bg-gradient-review hover:bg-secondary-dark text-white px-4 py-3 rounded-lg transition-colors w-full">';
