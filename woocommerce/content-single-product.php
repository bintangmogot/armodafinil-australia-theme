    ...
    <div class="armo-product-tabs mt-8 mb-16">
        <div class="border-b border-gray-200">
            <nav class="-mb-px flex space-x-8 overflow-x-auto hide-scrollbar" aria-label="Tabs" id="product-tabs-nav">
                ...
                <?php endif; ?>
                <?php if ($dosage): ?>
                    <button class="tab-btn border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-bold text-sm uppercase tracking-wide" data-target="tab-dosage">
                        Dosage & Direction
                    </button>
                <?php endif; ?>
                <?php if ($shipping): ?>
                    <button class="tab-btn border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-bold text-sm uppercase tracking-wide" data-target="tab-shipping">
                        Shipping & Returns
                    </button>
                <?php endif; ?>
                <?php if ($safety): ?>
                    <button class="tab-btn border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-bold text-sm uppercase tracking-wide" data-target="tab-safety">
                        Safety & Side Effects
                    </button>
                <?php endif; ?>
            </nav>
