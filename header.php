                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="tel:0455241294" class="hidden lg:flex items-center gap-2 mr-2 hover:opacity-80 transition-opacity">
                        <div class="w-10 h-10 flex-shrink-0 flex items-center justify-center">
                            <svg viewBox="0 0 308 308" fill="#25D366" class="h-full w-full">
                        ...
                        <div class="flex flex-col text-primary-dark">
                            <span class="text-[13px] font-bold leading-none tracking-wide uppercase">Call</span>
                            <span class="text-[19px] font-extrabold leading-tight tracking-tight">0455 241 294</span>
                        </div>
                    </a>
